...
const About: FC = () => {
  return (
    <motion.div
      className="flex flex-col gap-10 md:justify-evenly md:gap-0 pt-[20vh] md:pt-0 relative h-screen text-center md:text-left md:flex-row max-w-7xl px-10 mx-auto items-center"
      initial={{ opacity: 0 }}
